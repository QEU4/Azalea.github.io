...
<body>
  ...
  if (!$conn) {
    ...
    $sql = "select `id`, `name`, `recommendLevel`, `feature`, `recommendations`, `rate` FROM `questioner`";
    
    try {
      $result = $conn->query($sql);
  } catch (mysqli_sql_exception $e) {
      // Log or display a more meaningful error message
  ...
  <div style="text-align: center; border:black 3px; margin-top: 20px;">
    <a style="color: hsl(340, 57%, 64%);" href="test.php">Back to questioner page</a>
  </div>
  <!--
<th>Delete</th>
<td><a href='QuestionerDelet.php?id=" . $row["id"] . "'>delete</a></td>
  -->
